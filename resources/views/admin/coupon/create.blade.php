            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <form class="ann-card" method="POST" action="{{ route('admin.coupon.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" class="ann-control" placeholder="e.g. SAVE20"
                                                value="{{ old('code') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="discount_value" class="ann-control" placeholder="$ 0.00"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" rows="4" class="ann-control textarea-field"
                                                placeholder="e.g. Choice of: Two vouchers...">{{ old('details') }}</textarea>
