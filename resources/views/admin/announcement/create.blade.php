            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        ...
                        <div class="ann-card ann-preview">
                            ...
                            <div class="ann-card-body">
                                ...
                                <div class="ann-preview-texts">
                                    <div id="pvTitle" class="ann-preview-title">e.g. 46% Off – Two Vouchers…</div>
                                    <div id="pvDesc" class="ann-preview-desc">We are proud to announce launch of new branch</div>
                                </div>
                        ...
                        <!-- Form card -->
                        <form id="annForm" class="ann-card" method="POST" action="{{ route('admin.announcement.store') }}">
                            @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="ann-field">
                                            ...
                                            <input type="hidden" id="fIcon" name="icon" value="{{ old('icon','megaphone') }}">

                                            <div class="icon-grid" role="listbox" aria-label="Announcement icons">
                                                <button type="button" class="icon-chip is-selected" title="Megaphone"><i data-lucide="megaphone"></i></button>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="fDesc" name="description" rows="4" class="ann-control textarea-field"
                                                placeholder="We are proud to announce launch of new branch">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="fBtnText" name="button_text" type="text" class="ann-control"
                                                placeholder="Announcement" value="{{ old('button_text', 'Announcement') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="fBtnLink" name="button_link" type="url" class="ann-control"
                                                placeholder="https://" value="{{ old('button_link') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="fStartDate" name="start_date" type="date" class="ann-control" value="{{ old('start_date') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="fEndDate" name="end_date" type="date" class="ann-control" value="{{ old('end_date') }}">
                                        </div>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // ✅ If old value exists, set label (after DOM)
        const oldListingName = listingNameInput ? listingNameInput.value : '';
        if (oldListingName && announcementSelect) {
