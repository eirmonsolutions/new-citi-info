...
<main class="main-dashboard">
    ...
    if ($hour < 12) {
        ...
        <h1>
        Hi Admin, <span class="text-color">{{ $greeting }}...!</span>
        </h1>
                    ...
                    <div class="stat-card customers-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-number-row">
                                <p class="stat-number">Total Listings</p>
                                <a href="{{ route('admin.listing.index') }}" class="stat-button customers-button">
                                    <span>More info</span>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="stat-card drivers-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-change drivers-change">
                                <span>{{ $totalAnnouncements ?? 0 }}</span>
                            </div>
                        </div>
                        <div class="stat-content">
                            <!-- <h3>1,520</h3> -->
                            <div class="stat-number-row">
                                <p class="stat-number">Announcements</p>
                                <a href="{{ route('admin.announcement.index') }}" class="stat-button drivers-button">
                                    <span>More info</span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="stat-card vehicles-card">
                        ...
                        <div class="stat-content">
                            <!-- <h3>890</h3> -->
                            <div class="stat-number-row">
                                <p class="stat-number">Events</p>
                                <a href="{{ route('admin.event.index') }}" class="stat-button vehicles-button">
                                    <span>More info</span>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="stat-card invoices-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-change invoices-change">
                                <span>{{ $totalCoupons ?? 0 }}</span>
                            </div>
                        </div>
                        <div class="stat-content">
                            <!-- <h3>1,200</h3> -->
                            <div class="stat-number-row">
                                <p class="stat-number">Coupons</p>
                                <a href="{{ route('admin.coupon.index') }}" class="stat-button invoices-button">
                                    <span>More info</span>
                                </a>
                            </div>
                        </div>
